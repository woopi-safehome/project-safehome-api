...
ALTER TABLE IF EXISTS analysis_jobs ADD COLUMN IF NOT EXISTS anonymous_id VARCHAR(64) NULL COMMENT '비회원 작업의 주인 (익명 쿠키)';
...
CREATE TABLE IF NOT EXISTS analysis_jobs (
    ...
    anonymous_id VARCHAR(64) NULL COMMENT '비회원 작업의 주인 (익명 쿠키)',
